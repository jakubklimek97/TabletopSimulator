...
import static pl.polsl.gk.tabletopSimulator.nuklear.IOUtil.ioResourceToByteBuffer;
...
public class InterfaceHandler {
    ...
    public InterfaceHandler(long window){
        this.window = window;
        try{
    ...
    private void loadFont(NkContext ctx){
        int BITMAP_W = 1024;
        int BITMAP_H = 1024;
