...
import pl.polsl.gk.tabletopSimulator.engine.assimp.Material;
import pl.polsl.gk.tabletopSimulator.engine.assimp.Mesh;
import pl.polsl.gk.tabletopSimulator.engine.assimp.Utils;
import pl.polsl.gk.tabletopSimulator.engine.assimp.Node;
import pl.polsl.gk.tabletopSimulator.engine.assimp.Bone;
import pl.polsl.gk.tabletopSimulator.engine.assimp.VertexWeight;
...
public class AnimMeshesLoader extends StaticMeshesLoader {
    ...
    public static AnimatedEntity loadAnimGameItem(String resourcePath, String texturesDir)
            throws Exception {
    ...
    public static AnimatedEntity loadAnimGameItem(String resourcePath, String texturesDir, int flags)
            throws Exception {
        ...
        AnimatedEntity item = new AnimatedEntity(meshes, animations);
